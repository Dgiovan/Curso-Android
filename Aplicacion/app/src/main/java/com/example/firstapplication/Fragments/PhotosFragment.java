 ...
 */
public class PhotosFragment extends BaseFragmentListener {
    ...
    public static PhotosFragment newInstance(OnFragmentIteractionListener onFragmentIteractionListener){
