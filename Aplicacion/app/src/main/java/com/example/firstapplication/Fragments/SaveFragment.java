 ...
 */
public class SaveFragment extends BaseFragmentListener {
    ...
    public static SaveFragment newInstance(OnFragmentIteractionListener onFragmentIteractionListener){
